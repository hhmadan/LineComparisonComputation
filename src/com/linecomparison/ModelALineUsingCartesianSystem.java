//UC1_model a line based on a point of (x, y) co-ordinates using the Cartesian system, to calculate its length...
//Length as 2 Points (x1, y1) and (x2, y2) - Length of a Line = sqrt( (x2 - x1)
...
public class ModelALineUsingCartesianSystem {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Length of given Line having points "+"("+x1+","+y1+")"+"  "+"("+x2+","+y2+")"+" is: "
